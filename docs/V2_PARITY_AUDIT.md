...
| Metrics | v2 emits `loss` key; pawn-run dashboard expects `train/loss`/`train/accuracy` → blank loss chart/KPI | regression | major | `scripts/train_jax.py:665-672`; `dashboard/charts.py:344`; `sol.py:552` | Emit `train/loss`+`train/accuracy` (or update chart specs) |
