...
ARCH="${1:-x86-64-avx2}"
# Pin to the sf18-v0.1.0 tag of our fork — based on Stockfish 18 release
...
# nn-37f18f62d772.nnue (small), the same NNUE weights as vanilla SF18. Every
# command other than `evallegal` is bit-identical to vanilla SF18.
