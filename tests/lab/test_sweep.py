...
class TestBuiltinDistributions:
    ...
    def test_common_fields_in_all_spaces(self) -> None:
...
class TestParseDistribution:
    ...
    def test_parse_float_log(self) -> None:
    ...
    def test_parse_int_with_step(self) -> None:
        dist = parse_distribution({"type": "int", "low": 0, "high": 100, "step": 10})
        assert isinstance(dist, d.IntDistribution)
        assert dist.step == 10

    def test_parse_categorical(self) -> None:
