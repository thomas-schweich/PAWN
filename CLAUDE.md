...
│   ├── lichess_cache.py         # Lichess Elo-stratified tokenized cache (framework-agnostic)
│   ├── lichess_data.py          # Lichess parquet pipeline (polars + Rust engine)
...
The Lichess Elo-stratified eval is at `pawn.lichess_eval`.
